...
import { compareGoogleDocsTool } from "../tools/compareGoogleDocs";
...
export class WorkspaceAgent extends AIChatAgent<Env> {
  ...
  protected async onStart() {
    ...
    this
      .setSystemPrompt(`You are the Workspace Agent, an expert Cloudflare and Google Workspace orchestration AI.
